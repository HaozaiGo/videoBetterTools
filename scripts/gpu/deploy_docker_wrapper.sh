...
services:
  gpu-api:
    ...
    environment:
      ...
      MODEL_PLAZA_GPU_DEVICE_IDS: "2,3,4,5,6,7"
      MODEL_PLAZA_GPU_MONITOR_DEVICE_IDS: "0,1,2,3,4,5,6,7"
      CUDA_VISIBLE_DEVICES: "2,3,4,5,6,7"
      MODEL_PLAZA_GPU_WORKERS_PER_DEVICE: "1"
      MODEL_PLAZA_GPU_DEVICE_SLOT_CAPACITY: "2:1,3:2,4:1,5:1,6:1,7:2"
      MODEL_PLAZA_GPU_MAX_WORKERS: "8"
      MODEL_PLAZA_GPU_UPLOAD_RESULTS: "0"
      MODEL_PLAZA_GPU_RESULT_UPLOAD_TOTAL_TIMEOUT: "1800"
      MODEL_PLAZA_GPU_PREFLIGHT_ENABLED: "1"
      MODEL_PLAZA_GPU_DISK_PREFLIGHT_ENABLED: "1"
      MODEL_PLAZA_GPU_MIN_FREE_BYTES: "536870912000"
      MODEL_PLAZA_GPU_MIN_FREE_PERCENT: "8"
      ...
      MODEL_PLAZA_GPU_CLEANUP_INTERVAL_SECONDS: "300"
      MODEL_PLAZA_GPU_CLEANUP_SUCCESS_TTL_SECONDS: "86400"
      MODEL_PLAZA_GPU_CLEANUP_FAILED_TTL_SECONDS: "172800"
      MODEL_PLAZA_GPU_CLEANUP_RUNNER_WORK_TTL_SECONDS: "900"
      MODEL_PLAZA_GPU_CLEANUP_DISK_HIGH_WATERMARK_PERCENT: "75"
      MODEL_PLAZA_GPU_CLEANUP_DISK_LOW_WATERMARK_PERCENT: "65"
